...
SUBSCRIPTION_MAKE_TARGETS = (
    ...
    ("subpage-brands-check:", "sub-next-config-plan"),
    ("subpage-brands:", "sub-next-config-apply"),
    ("external-squads-check:", "PLAY_SUB)"),
    ("external-squads:", "PLAY_SUB)"),
    ("subscription-branding-check:", "PLAY_SUB)"),
    ("subscription-branding:", "PLAY_SUB)"),
...
TARGET_TAG_EXPECTATIONS = (
    ...
    ("external-squads-check:", "--tags external_squads"),
    ("external-squads:", "--tags external_squads"),
    ("subscription-branding-check:", "--tags subscription_branding"),
    ("subscription-branding:", "--tags subscription_branding"),
...
SPECIAL_INCLUDE_OPERATIONS = (
    ...
    },
    {
        ...
        "wrapper_tags": {"never", "sub_next_config", "sub_next_full", "subscription_branding"},
        "apply_tags": {"sub_next_config", "sub_next_full", "subscription_branding"},
    },
    {
        "marker": "Manage Remnawave External Squads Subpage Config bindings",
        "wrapper_tags": {"never", "external_squads", "subscription_branding"},
        "apply_tags": {"external_squads", "subscription_branding"},
        "role": "remnawave_external_squads",
    },
    {
...
STAGING_PLAY_MARKERS = (
    ...
    "Manage Remnawave External Squads Subpage Config bindings",
